...
public class LandlordDetailActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.place_detailsview_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.deleteplacemenuitem:
                // will add place or update place
                new JSONParseDel().execute();
                return true;

            case R.id.editplacemenuitem:
                // will add place or update place
                Intent intent = new Intent(this, AddUpdatePlaceActivity.class);
                intent.putExtra("update", true);
                intent.putExtra("placeid", id);
                intent.putExtra("result", placejsonstring);
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(LandlordDetailActivity.this);
        ...
        protected JSONObject doInBackground(String... args) {
            String email = Utility.getValueFromSP(LandlordDetailActivity.this, "email");
...
//            JSONObject propertyType=new JSONObject();
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            pDialog.dismiss();
            try {
                Toast.makeText(LandlordDetailActivity.this, "added to favourite", Toast.LENGTH_LONG).show();
    ...
    private class JSONParseDel extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            String url = "http://52.39.4.163:3000/api/landlord/deletePlace/" + id;
            // Getting JSON from URL
        ...
        protected void onPostExecute(JSONObject json) {
            pDialog.dismiss();
            try {
                System.out.println("INSIDE ON POST EXEC AND DELETTION IS DONE");
                Toast.makeText(LandlordDetailActivity.this, "deleted from favourite", Toast.LENGTH_LONG).show();
