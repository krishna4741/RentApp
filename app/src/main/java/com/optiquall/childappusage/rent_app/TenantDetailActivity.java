...
Toast.makeText(this,"your string",Toast.LENGTH_LONG).show();
//T
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            inflater.inflate(R.menu.menu_tenant_detail_activity, menu);
            return true;
        }
...
//                    actionBar.setBackgroundDrawable(new ColorDrawable(Color.RED));
                    ...
                    item.setIcon(item.isChecked() ? R.drawable.newheart: R.mipmap.ic_action_action_favorite_outline);
                   // item.setIcon(R.drawable.newheart);
        ...
        private class JSONParse extends AsyncTask<String, String, JSONObject> {
            ...
            protected JSONObject doInBackground(String... args) {
                String email = Utility.getValueFromSP(TenantDetailActivity.this, "email");
...
//        String url = "http://52.39.4.163:3000/api/tenant/favouritePlace/" + id;
        ...
        private class JSONParse1 extends AsyncTask<String, String, JSONObject> {
            ...
            protected void onPostExecute(JSONObject json) {
                pDialog.dismiss();
                try {
                    Toast.makeText(TenantDetailActivity.this, "added to favourite", Toast.LENGTH_LONG).show();
        ...
        private class JSONParseDel extends AsyncTask<String, String, JSONObject> {
            ...
            protected void onPostExecute(JSONObject json) {
                pDialog.dismiss();
                try {
                    Toast.makeText(TenantDetailActivity.this, "deleted from favourite", Toast.LENGTH_LONG).show();
